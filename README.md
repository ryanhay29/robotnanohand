...
This release is **calibrated to my hand setup** and works only on **ARM64 Macs**.  
...
- This is a **personal build**; slider ranges and preset poses are tuned to the hand I used.
